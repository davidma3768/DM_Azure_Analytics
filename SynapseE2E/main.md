...
![serverless_usecases](/docs/images/serverless_usecases.jpg)
### Explore JSON data with Serverless Query
![OnDemonQuery4JSON](/docs/images/OnDemonQuery4JSON.jpg)
...
![FlattenJSON_Spark](/docs/images/FlattenJSON_Spark.jpg)
### Flatten nested JSON data with Dataflow
![FlattenJSON_Dataflow](/docs/images/FlattenJSON_Dataflow.jpg)
## Dedicated SQL Pool 
